                ...
                <div className="flex flex-wrap gap-1.5">
                  {message.sources.map((src, idx) => (
                    <a
                      ...
                      className="text-[11px] px-2 py-0.5 rounded-full bg-slate-700/70 hover:bg-slate-700 text-blue-300 hover:text-blue-200 flex items-center gap-1 border border-slate-600/50 transition-colors"
                      title={src.url}
                    >
              ...
              <div className="flex items-center gap-1">
                {onSaveAsNote && (
                  <button
                    ...
                    className="p-1 hover:bg-slate-700 rounded text-slate-300 hover:text-white transition-colors flex items-center gap-1"
